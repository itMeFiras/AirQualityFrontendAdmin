...
export class UsersService {
  ...
  editAccount(id : any, data:Users ) : Observable<Users>{
    return this.HttpClient.post<Users>(this.url+'/editprofile/'+id,data)
  }

  toggelActive(id : any) : Observable<Users>{
    return this.HttpClient.post<Users>(this.url+'/toggelActive/'+id,"")
  }
